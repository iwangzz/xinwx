...
CLASS WXHongBao {
    ...
    private $mch_id = "1248581201";//商户ID写死
    private $wxappid = "wx367f9110a3d96fcb";//微信公众号，写死
    private $client_ip = "121.42.87.18"; //调用红包接口的主机的IP,服务端IP,写死，即脚本文件所在的IP
    private $apikey = "9a1080e9f62a5aba454cdc7e8e02c1cb";//pay的秘钥值
    private $total_num = 1;//发放人数。固定值1，不可修改    
    private $nick_name = "新雨瑞饮品"; //红包商户名称
    private $send_name = "新雨瑞饮品";//红包派发者名称
    private $wishing = "祝福语"; //    
    ...
    function __construct(){
        ...
        $this->apiclient_cert = APP_PATH ."Common/Controller/apiclient_cert.pem";
        $this->apiclient_key = APP_PATH ."Common/Controller/apiclient_key.pem";
    }
    ...
    private function gen_Sign(){
        ...
        // header('Content-type: text/html; charset=utf-8');
        // $b = 'act_name=发钱活动&client_ip=121.42.87.18&mch_billno=1248581201201603096626011335&mch_id=1248581201&nonce_str=24FEEFB7B762C97F8B9C4488068A1218&re_openid=o7ly_vobRMYJ-mlZcnfpqtx-LDrQ&remark=任性一把&send_name=新雨瑞饮品&total_amount=100&total_num=1&wishing=恭喜发财&wxappid=wx367f9110a3d96fcb&key= 9a1080e9f62a5aba454cdc7e8e02c1cb';
        // $a = 'act_name=发钱活动&client_ip=121.42.87.18&mch_billno=1248581201201603096626011335&mch_id=1248581201&nonce_str=24FEEFB7B762C97F8B9C4488068A1218&re_openid=o7ly_vobRMYJ-mlZcnfpqtx-LDrQ&remark=任性一把&send_name=新雨瑞饮品&total_amount=100&total_num=1&wishing=恭喜发财&wxappid=wx367f9110a3d96fcb&key=9a1080e9f62a5aba454cdc7e8e02c1cb';
        // echo mb_detect_encoding('act_name=发钱活动&client_ip=121.42.87.18&mch_billno=1248581201201603096626011335&mch_id=1248581201&nonce_str=24FEEFB7B762C97F8B9C4488068A1218&re_openid=o7ly_vobRMYJ-mlZcnfpqtx-LDrQ&remark=任性一把&send_name=新雨瑞饮品&total_amount=100&total_num=1&wishing=恭喜发财&wxappid=wx367f9110a3d96fcb&key=9a1080e9f62a5aba454cdc7e8e02c1cb');
        // echo '----------------------';
        $this->sign = strtoupper(md5(trim($sign_raw)));
        // echo $this->sign; exit;
