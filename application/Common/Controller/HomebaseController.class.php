...
include include APP_PATH . 'Common/Controller/WXHongBao.php';
class HomebaseController extends AppframeController
{
    ...
    //公共curl 传递公共的接口参数并获取
    public function curlData($url, $data = null)
    {
        $ch = curl_init();
        ...
        if (!empty($data)) {
            ...
            curl_setopt($ch, CURLOPT_POSTFILES, $data);
        }
    ...
    public function get_token()
    {
        ...
        $json = $this->curlData($get_token_url);
    ...
    public function createMenu()
    {
        ...
        $result = $this->curlData($menu_url, $data);
        if ($result)
            echo $result;
    }
